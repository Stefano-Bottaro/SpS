...
Public Class GridExportingController
    ...
    End Sub
    <System.Web.Http.ActionName("ExcelExport")> _
    <AcceptVerbs("POST")> _
    Public Sub ExcelExport()
        ...
        Using context As ServerApplicationContext = ServerApplicationContext.CreateContext()
            ...
            Dim data As IEnumerable = context.DataWorkspace.ApplicationData.WorkSpaces.GetQuery.Execute.ToList()
            exp.Export(gridPropert, DirectCast(data, IEnumerable), "Export.xlsx", ExcelVersion.Excel2010)
        End Using
    End Sub
    <System.Web.Http.ActionName("WordExport")> _
    <AcceptVerbs("POST")> _
    Public Sub WordExport()
        ...
        End Using
    End Sub
    <System.Web.Http.ActionName("PdfExport")> _
    <AcceptVerbs("POST")> _
